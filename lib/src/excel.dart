...
class ExcelDart {
  ...
  ///
  /// If changes have been to [insertion_order.proto] or
  ...
  static List _generateTableRow(InsertionOrder io) => [
        io.insertionOrderId,
        io.advertiserId,
        io.campaignId,
        io.displayName,
  ...
  static String _calculateTotalBudgetAmount(
      List<InsertionOrder_InsertionOrderBudget_InsertionOrderBudgetSegment>
          budgetSegments) {
    var budgetAmountList = budgetSegments
        .map((segment) => Int64.parseInt(segment.budgetAmountMicros))
        .toList();
    var totalBudgetMicros =
        budgetAmountList.reduce((value, element) => value + element);
